...
namespace TrainingTracker.Api.Migrations
{
    ...
    [Migration("20260729123827_AddAuthRefreshAndGoals")]
    partial class AddAuthRefreshAndGoals
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TrainingTracker.Api.Models.AppUser", b =>
                {
                    ...
                    b.Property<DateTime?>("LastStepsImportAt")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<int?>("StreakGoalDays")
                        .HasColumnType("int");

                    b.Property<int>("WeekStartsOn")
                        .HasColumnType("int");

                    b.Property<int?>("WeeklyTrainingMinutesGoal")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TrainingTracker.Api.Models.DailySteps", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TrainingTracker.Api.Models.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TrainingTracker.Api.Models.TrainingSession", b =>
                {
                    ...
                    b.Property<int?>("ImportedCalories")
                        .HasColumnType("int");
